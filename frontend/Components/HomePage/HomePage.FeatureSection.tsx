      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mx-10 md:mx-0">
          <FeatureCard
            ...
            cardDescription="Track your expenses through multiple methods - manual entry, receipt scanning, and automated bank transaction imports."
          />
          ...
          <FeatureCard
            ...
            cardDescription="Built with modern tech stack ensuring smooth performance, real-time updates, and seamless synchronization across devices."
          />
          ...
          <FeatureCard
            ...
            cardDescription="Your financial data is protected with industry-standard encryption, secure authentication, and regular security updates."
          />
          ...
          <FeatureCard
            ...
            cardDescription="Intuitive interface with easy expense tracking, budget management, and insightful financial reports at your fingertips."
          />
        </div>
      </div>
    </section>
