...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-gray-200">
      <div className="flex">
        <Sidebar />
        <div className="min-h-screen flex-1 bg-black p-5 font-sans flex justify-center items-center bg-cover bg-center"
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      <input
                        ...
                        className="mt-1 p-2 w-full border rounded-md focus:ring-blue-300 focus:outline-none"
                      />
                    ) : (
                      <p className="mt-1 p-2 w-48 bg-white bg-opacity-70 rounded-md">{userData.username}</p>
                    )}
                  </div>
                </div>
                <div className="mb-4">
                  ...
                  {isEditing ? (
                    ...
                    <p className="mt-1 p-2 bg-white bg-opacity-70 rounded-md">••••••••</p>
                  )}
                </div>
                <div className="mb-4">
                  <label className="block text-sm font-medium">Email</label>
                  <p className="mt-1 p-2 bg-white bg-opacity-70 rounded-md">{userData.email}</p>
                </div>
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="mt-1 p-2 bg-white bg-opacity-70 rounded-md">{userData.contactNumber}</p>
                  )}
                </div>
              </div>
                ...
                <div className="mb-4">
                  ...
                  {isEditing ? (
                    <select
                      ...
                      className="mt-1 p-2 w-48 border rounded-md focus:ring-blue-300 focus:outline-none"
                    >
                    ...
                    <p className="mt-1 p-2 w-48 bg-white bg-opacity-70 rounded-md">{userData.gender}</p>
                  )}
                </div>
                <div className="mb-4">
                  ...
                  {isEditing ? (
                    ...
                    <p className="mt-1 p-2 bg-white bg-opacity-70 rounded-md">{userData.language}</p>
                  )}
                </div>
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="mt-1 p-2 bg-white bg-opacity-70 rounded-md">
